  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        {icon && (
          <div className="absolute left-3 top-1/2 -translate-y-1/2 text-white/78 pointer-events-none" aria-hidden="true">
            {icon}
          </div>
        )}
        <input
          ...
          className={cn(
            ...
            'placeholder:text-white/75 font-body',
      ...
      {hint && !error && (
        <p id={hintId} className="mt-1 font-mono text-[0.6rem] text-white/78">{hint}</p>
      )}
    </div>
  )
})
