    ...
    <>
      ...
      >
        ...
        <div className="px-5 pt-14 pb-4 border-b border-white/7">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="font-mono text-[0.65rem] text-white truncate">{profile?.university?.split('(')[0]?.trim() || 'University'}</div>
            </div>
            {isPremium && (
        ...
        <div className="flex-1 overflow-y-auto py-3 px-3 space-y-1">
          ...
          <div className="mb-2">
            <div className="font-mono text-[0.65rem] tracking-[0.18em] uppercase text-white px-2 mb-1">Home</div>
            {[
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active ? 'bg-teal-600/15 text-teal-400 border border-teal-600/20' : 'text-white hover:text-white hover:bg-white/5'
                  )}
                >
                  <span className="w-5 text-center text-base">{item.icon}</span>
                  {item.label}
                  {item.href === '/nova' && !isPremium && (
                    <span className="ml-auto font-mono text-[0.65rem] text-white">10/mo free</span>
                  )}
                </Link>
              )
            })}
              ...
              <div key={room.id} className="rounded-xl overflow-hidden" style={{ border: isOpen ? `1px solid ${room.color}22` : '1px solid transparent' }}>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="font-mono text-[0.65rem] text-white truncate">{room.tagline}</div>
                  </div>
                  <span
                    className="font-mono text-[0.65rem] flex-shrink-0 transition-transform duration-200"
                    style={{ color: '#fff', transform: isOpen ? 'rotate(180deg)' : 'none' }}
                  >
                    ▾
                  </span>
                </button>
          ...
          <div className="border-t border-white/7 mt-3 pt-3">
            <div className="font-mono text-[0.65rem] tracking-[0.18em] uppercase text-white px-2 mb-1.5">Account</div>

            <div className="px-2 py-2 mb-1">
              <div className="flex items-center gap-2 mb-1.5">
                <span className="text-base w-5 text-center">🌍</span>
                <span className="font-display text-xs text-white">Nova Language</span>
              ...
              <select
                ...
                disabled={savingLang}
                className="w-full bg-white/5 border border-white/10 rounded-lg px-2 py-1.5 font-mono text-[0.65rem] text-white focus:outline-none focus:border-teal-600/50 disabled:opacity-40"
              >
                {SA_LANGUAGES.map(l => (
            ...
            {[
              ...
              <Link key={item.href} href={item.href} onClick={onClose} className="flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-display text-white hover:text-white hover:bg-white/5 transition-all mb-0.5">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-display text-white hover:text-red-400 hover:bg-red-500/5 transition-all"
            >
              <span className="text-base w-5 text-center">🚪</span>
              Sign Out
            </button>
        ...
        <div className="px-5 py-3 border-t border-white/7">
          <p className="font-mono text-[0.65rem] text-white leading-relaxed">
