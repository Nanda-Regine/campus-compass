  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div>
        ...
        <div className="font-mono text-[0.6rem] text-white/35 mt-1 leading-relaxed">
      ...
      <div className="space-y-2">
        <div className="grid grid-cols-2 gap-2">
          <input
            ...
            className="col-span-2 w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-white placeholder:text-white/20 outline-none focus:border-purple-500 font-body"
          />
        </div>
        ...
        <div className="relative">
          <textarea
            ...
            rows={7}
            className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2.5 text-sm text-white placeholder:text-white/20 outline-none focus:border-purple-500 resize-none font-body leading-relaxed"
          />
          {/* Character progress */}
        ...
        <div className="space-y-5">
          ...
          {kit.key_concepts.length > 0 && (
            <div className="bg-white/3 border border-white/7 rounded-2xl p-4">
              <div className="font-mono text-[0.55rem] text-white/35 tracking-widest mb-3">KEY CONCEPTS</div>
            ...
            <div className="bg-white/3 border border-white/7 rounded-2xl p-4">
              ...
              {!saved ? (
                <div className="mt-4 pt-3 border-t border-white/8 space-y-2">
                  <div className="font-mono text-[0.55rem] text-white/35 tracking-widest">SAVE TO FLASHCARD DECK</div>
                  <select
                    value={deckId}
                  ...
                  {deckId === '__new__' && (
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-white placeholder:text-white/20 outline-none focus:border-purple-500 font-body"
                    />
                  )}
                  <button
                  ...
                  <div className="space-y-3">
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              ...
                              showResult && !isPicked && !isRight && 'bg-white/2 border-white/5 text-white/30',
                            )}
                          >
                            {opt}
                    ...
                    <div className="flex gap-2 pt-1">
                      <button
                        ...
                        disabled={quizIdx === 0}
                        className="flex-1 font-mono text-[0.6rem] py-2 rounded-xl border border-white/10 text-white/40 disabled:opacity-25 hover:border-white/20 transition-all"
                      >
                        ← Prev
                      </button>
                      <button
          ...
          <button
            ...
            className="w-full font-mono text-[0.6rem] py-2 rounded-xl border border-white/10 text-white/30 hover:text-white/50 hover:border-white/20 transition-all"
          >
      ...
      {!kit && !generating && (
        <div className="bg-white/2 border border-white/6 rounded-2xl p-4 space-y-2">
          <div className="font-mono text-[0.55rem] text-white/25 tracking-widest">TIPS FOR BEST RESULTS</div>
          <ul className="space-y-1.5">
            {[
              ...
              <li key={i} className="flex items-start gap-2">
                ...
                <span className="font-mono text-[0.58rem] text-white/35 leading-relaxed">{tip}</span>
              </li>
            ))}
          </ul>
        </div>
