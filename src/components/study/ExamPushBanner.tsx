    ...
    return (
      <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-teal-600/8 border border-teal-600/15">
        ...
        <button
          onClick={unsubscribe}
          disabled={loading}
          className="font-mono text-[0.55rem] text-white/50 hover:text-white/70 transition-colors disabled:opacity-40"
        >
          Turn off
        </button>
      </div>
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="font-mono text-[0.58rem] text-white/60">
