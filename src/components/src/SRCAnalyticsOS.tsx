          ...
          return (
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                ...
                <span style={{ fontSize: '0.6rem', color: '#fff', fontFamily: 'var(--font-mono)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 4, color: '#fff', fontFamily: 'var(--font-mono)', fontSize: '0.65rem' }}>
                  <Eye size={12} />
                  {post.views_count}
                </div>
              </div>
    ...
    <div>
      {members.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '48px 24px', color: '#fff' }}>
          ...
          <div style={{ fontFamily: 'var(--font-display)', fontWeight: 600, fontSize: '0.9rem', marginBottom: 6, color: '#fff' }}>
          ...
          {members.map(member => (
            <div key={member.id} className="card-base" style={{ padding: 16, display: 'flex', gap: 14, alignItems: 'flex-start' }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {member.portfolio && (
                  <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.62rem', color: '#fff', marginBottom: 4 }}>
                    Portfolio: {member.portfolio}
                  </div>
                )}
                {member.bio && (
                  <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.78rem', color: '#fff', lineHeight: 1.5 }}>
                    {member.bio}
                  </div>
                )}
              </div>
  ...
  if (!isSrcMember) {
    return (
      <div className="card-base" style={{ padding: 32, textAlign: 'center' }}>
        ...
        <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.8rem', color: '#fff', lineHeight: 1.55, maxWidth: 280, margin: '0 auto' }}>
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="card-base" style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          {/* Title */}
          <div>
            <label style={{ fontFamily: 'var(--font-mono)', fontSize: '0.62rem', letterSpacing: '0.06em', textTransform: 'uppercase', color: '#fff', display: 'block', marginBottom: 6 }}>
              Title *
            </label>
            <input
              value={title}
            ...
            />
            <div style={{ textAlign: 'right', fontFamily: 'var(--font-mono)', fontSize: '0.63rem', color: '#fff', marginTop: 3 }}>
              {title.length}/120
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <ChevronDown size={14} style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', color: '#fff', pointerEvents: 'none' }} />
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div>
              ...
              <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.7rem', color: '#fff' }}>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <div className="card-base" style={{ padding: 16 }}>
        ...
        <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.8rem', color: '#fff', lineHeight: 1.6 }}>
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', gap: 10 }}>
              ...
              <div>
                ...
                <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.73rem', color: '#fff', lineHeight: 1.5 }}>{item.detail}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {[
            ...
            <div key={i} style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
              ...
              <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.78rem', color: '#fff', lineHeight: 1.55, flex: 1 }}>
                {step}
              </div>
            </div>
          ))}
      ...
      <div className="card-base" style={{ padding: 16 }}>
        ...
        <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.8rem', color: '#fff', lineHeight: 1.6, marginBottom: 12 }}>
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.72rem', color: '#fff', lineHeight: 1.5 }}>{item.detail}</div>
              </div>
            </div>
          ))}
        </div>
