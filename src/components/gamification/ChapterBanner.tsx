  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 10 }}>
        <div>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.65rem', color: '#fff', letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: 4 }}>
            Current Chapter
          </div>
      ...
      <div style={{ marginTop: 6, fontFamily: 'var(--font-mono)', fontSize: '0.65rem', color: '#fff' }}>
