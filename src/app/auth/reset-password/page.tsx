    ...
    return (
      <div className="min-h-screen bg-[var(--bg-base)] flex flex-col">
        <div className="px-5 pt-12 pb-8 text-center">
          ...
          <p className="font-mono text-xs text-white">Choose something strong and memorable.</p>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)] flex flex-col">
      <div className="px-5 pt-12 pb-8 text-center">
        ...
        <p className="font-mono text-xs text-white">We&apos;ll send you a link to reset it.</p>
      </div>
