  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[var(--bg-base)] flex items-center justify-center">
        <div className="font-mono text-white/65 text-sm">Loading invite…</div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-[var(--bg-base)] flex items-center justify-center px-6">
        <div className="text-center">
          ...
          <p className="font-mono text-sm text-white/65 mb-6">{error}</p>
          <button
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)] flex items-center justify-center px-6" style={{ position: 'relative', overflowX: 'hidden' }}>
      ...
      <div className="max-w-sm w-full text-center">
        ...
        <p className="font-mono text-[0.7rem] text-white/65 mb-6">
        ...
        <div className="bg-white/3 border border-white/10 rounded-2xl p-4 mb-6 text-left">
          ...
          {assignment?.due_date && (
            <p className="font-mono text-[0.62rem] text-white/65 mt-1">
        ...
        <p className="font-mono text-[0.58rem] text-white/50">
