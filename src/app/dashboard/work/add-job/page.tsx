...
export default function AddJobPage() {
  ...
  return (
    <div className="min-h-screen pb-24" style={{ background: 'var(--bg-base)', position: 'relative', overflow: 'hidden' }}>
      <AmbientImage zone="career" opacity={0.34} blurPx={6} saturation={1.4} overlayColor="linear-gradient(180deg,rgba(5,4,12,0.55) 0%,rgba(5,4,12,0.64) 100%)" />
      ...
      <div className="px-4 py-3 max-w-2xl mx-auto">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="font-mono text-[0.6rem] tracking-[0.14em] uppercase text-white mb-2">Job type</div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="font-mono text-[0.6rem] text-white uppercase">On campus</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                ...
                className="w-4 h-4 accent-teal-500"
              />
              <span className="font-mono text-[0.6rem] text-white uppercase">Remote</span>
            </label>
          </div>
