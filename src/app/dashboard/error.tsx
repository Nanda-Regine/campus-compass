  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)] flex items-center justify-center px-6">
      <div className="text-center">
        ...
        <p className="font-mono text-[0.6rem] text-white mb-6">Dashboard failed to load. Try again or go home.</p>
        <div className="flex gap-3 justify-center">
          ...
          <Link href="/" className="font-mono text-[0.65rem] bg-white/5 border border-white/10 text-white px-4 py-2 rounded-xl transition-all hover:text-white">
            Go home
          </Link>
        </div>
      </div>
